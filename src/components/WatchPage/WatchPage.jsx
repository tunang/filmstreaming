...
const WatchPage = () => {
    ...
    return (
    <div className="absolute w-full grid grid-cols-8 mt-32 px-12">
        ...
        <>
            ...
            <Iframe className='w-full h-[500px] col-span-5' url={data.data.episodes[0].server_data[currentEp].link_embed}
            display="initial"
            position="relative"
            allowFullScreen/>     
